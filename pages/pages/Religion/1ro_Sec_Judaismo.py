...
with st.expander("📋 INDICACIONES", expanded=True): st.write("1) Resuelve TODO el Nivel 1.\n2) Elige UN reto.\n3) Completa en casa si falta tiempo.")
...
with col_s1: q5_1 = st.text_input("5.1) Semejanza 1:")
with col_s2: q5_2 = st.text_input("5.2) Semejanza 2:")
